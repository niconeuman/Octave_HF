function gout = OSsdss(RPAValues,RPBValues,RQCValues,RQDValues,RWPValues,RWQValues,pValues,qValues,ppqValues,gSSSSNValues)
...
%(sd|ss) from horizontal recursion on the bra 
s_dxx_s_s = ABx*s_px_s_s + px_px_s_s;
s_dxy_s_s = ABx*s_py_s_s + px_py_s_s;
s_dxz_s_s = ABx*s_pz_s_s + px_pz_s_s;
s_dyy_s_s = ABy*s_py_s_s + py_py_s_s;
s_dyz_s_s = ABy*s_pz_s_s + py_pz_s_s;
s_dzz_s_s = ABz*s_pz_s_s + pz_pz_s_s;
gout = zeros(1,6,1,1);
gout(1,1,1,1) = s_dxx_s_s;
gout(1,2,1,1) = s_dxy_s_s;
gout(1,3,1,1) = s_dxz_s_s;
gout(1,4,1,1) = s_dyy_s_s;
gout(1,5,1,1) = s_dyz_s_s;
gout(1,6,1,1) = s_dzz_s_s;
end