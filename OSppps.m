function gout = OSppps(RPAValues,RPBValues,RQCValues,RQDValues,RWPValues,RWQValues,pValues,qValues,ppqValues,gSSSSNValues)
...
gout = zeros(3,3,3,1);
gout(1,1,1,1) = px_px_px_s;
gout(1,1,2,1) = px_px_py_s;
gout(1,1,3,1) = px_px_pz_s;
gout(1,2,1,1) = px_py_px_s;
gout(1,2,2,1) = px_py_py_s;
gout(1,2,3,1) = px_py_pz_s;
gout(1,3,1,1) = px_pz_px_s;
gout(1,3,2,1) = px_pz_py_s;
gout(1,3,3,1) = px_pz_pz_s;
gout(2,1,1,1) = py_px_px_s;
gout(2,1,2,1) = py_px_py_s;
gout(2,1,3,1) = py_px_pz_s;
gout(2,2,1,1) = py_py_px_s;
gout(2,2,2,1) = py_py_py_s;
gout(2,2,3,1) = py_py_pz_s;
gout(2,3,1,1) = py_pz_px_s;
gout(2,3,2,1) = py_pz_py_s;
gout(2,3,3,1) = py_pz_pz_s;
gout(3,1,1,1) = pz_px_px_s;
gout(3,1,2,1) = pz_px_py_s;
gout(3,1,3,1) = pz_px_pz_s;
gout(3,2,1,1) = pz_py_px_s;
gout(3,2,2,1) = pz_py_py_s;
gout(3,2,3,1) = pz_py_pz_s;
gout(3,3,1,1) = pz_pz_px_s;
gout(3,3,2,1) = pz_pz_py_s;
gout(3,3,3,1) = pz_pz_pz_s;
end