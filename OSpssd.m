function gout = OSpssd(RPAValues,RPBValues,RQCValues,RQDValues,RWPValues,RWQValues,pValues,qValues,ppqValues,gSSSSNValues)
...
gout = zeros(3,1,1,6);
gout(1,1,1,1) = px_s_s_dxx;
gout(1,1,1,2) = px_s_s_dxy;
gout(1,1,1,3) = px_s_s_dxz;
gout(1,1,1,4) = px_s_s_dyy;
gout(1,1,1,5) = px_s_s_dyz;
gout(1,1,1,6) = px_s_s_dzz;
gout(2,1,1,1) = py_s_s_dxx;
gout(2,1,1,2) = py_s_s_dxy;
gout(2,1,1,3) = py_s_s_dxz;
gout(2,1,1,4) = py_s_s_dyy;
gout(2,1,1,5) = py_s_s_dyz;
gout(2,1,1,6) = py_s_s_dzz;
gout(3,1,1,1) = pz_s_s_dxx;
gout(3,1,1,2) = pz_s_s_dxy;
gout(3,1,1,3) = pz_s_s_dxz;
gout(3,1,1,4) = pz_s_s_dyy;
gout(3,1,1,5) = pz_s_s_dyz;
gout(3,1,1,6) = pz_s_s_dzz;
end