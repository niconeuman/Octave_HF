function Vout = ENsd(RPAValues,RPBValues,RPCValues,pValues,VssNValues)
Vs_s_0 = VssNValues(:,1);
Vs_s_1 = VssNValues(:,2);
Vs_s_2 = VssNValues(:,3);
PAx = RPAValues(:,1);
...
V = zeros(1,6);
V(1,1) = 1/1.73205080756888*Vs_dxx;
V(1,2) = Vs_dxy;
V(1,3) = Vs_dxz;
V(1,4) = 1/1.73205080756888*Vs_dyy;
V(1,5) = Vs_dyz;
V(1,6) = 1/1.73205080756888*Vs_dzz;
Vout = V;end
