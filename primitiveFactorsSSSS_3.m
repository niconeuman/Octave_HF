function gSSSSNValues = primitiveFactorsSSSS_3(basis_a,basis_b,basis_c,basis_d,Boys_Table,pair_data2,a,b,c,d)
...
%disp(PxValues);
%disp('KabValues calculated in-situ');
%disp(KabValues);
...
%disp(PxValues);
%disp('KabValues from pair_data2');
%disp(KabValues);
...
boysValuesLow = zeros(length(xValuesLow),1);
order = 0;
...
if ~isempty(xValuesHigh)
    ...
    boysValues(below35==0,:) = boysValuesHigh_0;
