function gout = OSdspp(RPAValues,RPBValues,RQCValues,RQDValues,RWPValues,RWQValues,pValues,qValues,ppqValues,gSSSSNValues)
...
gout = zeros(6,1,3,3);
gout(1,1,1,1) = dxx_s_px_px;
gout(1,1,1,2) = dxx_s_px_py;
gout(1,1,1,3) = dxx_s_px_pz;
gout(1,1,2,1) = dxx_s_py_px;
gout(1,1,2,2) = dxx_s_py_py;
gout(1,1,2,3) = dxx_s_py_pz;
gout(1,1,3,1) = dxx_s_pz_px;
gout(1,1,3,2) = dxx_s_pz_py;
gout(1,1,3,3) = dxx_s_pz_pz;
gout(2,1,1,1) = dxy_s_px_px;
gout(2,1,1,2) = dxy_s_px_py;
gout(2,1,1,3) = dxy_s_px_pz;
gout(2,1,2,1) = dxy_s_py_px;
gout(2,1,2,2) = dxy_s_py_py;
gout(2,1,2,3) = dxy_s_py_pz;
gout(2,1,3,1) = dxy_s_pz_px;
gout(2,1,3,2) = dxy_s_pz_py;
gout(2,1,3,3) = dxy_s_pz_pz;
gout(3,1,1,1) = dxz_s_px_px;
gout(3,1,1,2) = dxz_s_px_py;
gout(3,1,1,3) = dxz_s_px_pz;
gout(3,1,2,1) = dxz_s_py_px;
gout(3,1,2,2) = dxz_s_py_py;
gout(3,1,2,3) = dxz_s_py_pz;
gout(3,1,3,1) = dxz_s_pz_px;
gout(3,1,3,2) = dxz_s_pz_py;
gout(3,1,3,3) = dxz_s_pz_pz;
gout(4,1,1,1) = dyy_s_px_px;
gout(4,1,1,2) = dyy_s_px_py;
gout(4,1,1,3) = dyy_s_px_pz;
gout(4,1,2,1) = dyy_s_py_px;
gout(4,1,2,2) = dyy_s_py_py;
gout(4,1,2,3) = dyy_s_py_pz;
gout(4,1,3,1) = dyy_s_pz_px;
gout(4,1,3,2) = dyy_s_pz_py;
gout(4,1,3,3) = dyy_s_pz_pz;
gout(5,1,1,1) = dyz_s_px_px;
gout(5,1,1,2) = dyz_s_px_py;
gout(5,1,1,3) = dyz_s_px_pz;
gout(5,1,2,1) = dyz_s_py_px;
gout(5,1,2,2) = dyz_s_py_py;
gout(5,1,2,3) = dyz_s_py_pz;
gout(5,1,3,1) = dyz_s_pz_px;
gout(5,1,3,2) = dyz_s_pz_py;
gout(5,1,3,3) = dyz_s_pz_pz;
gout(6,1,1,1) = dzz_s_px_px;
gout(6,1,1,2) = dzz_s_px_py;
gout(6,1,1,3) = dzz_s_px_pz;
gout(6,1,2,1) = dzz_s_py_px;
gout(6,1,2,2) = dzz_s_py_py;
gout(6,1,2,3) = dzz_s_py_pz;
gout(6,1,3,1) = dzz_s_pz_px;
gout(6,1,3,2) = dzz_s_pz_py;
gout(6,1,3,3) = dzz_s_pz_pz;
end