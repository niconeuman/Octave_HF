function gout = OSppds(RPAValues,RPBValues,RQCValues,RQDValues,RWPValues,RWQValues,pValues,qValues,ppqValues,gSSSSNValues)
...
gout = zeros(3,3,6,1);
gout(1,1,1,1) = px_px_dxx_s;
gout(1,1,2,1) = px_px_dxy_s;
gout(1,1,3,1) = px_px_dxz_s;
gout(1,1,4,1) = px_px_dyy_s;
gout(1,1,5,1) = px_px_dyz_s;
gout(1,1,6,1) = px_px_dzz_s;
gout(1,2,1,1) = px_py_dxx_s;
gout(1,2,2,1) = px_py_dxy_s;
gout(1,2,3,1) = px_py_dxz_s;
gout(1,2,4,1) = px_py_dyy_s;
gout(1,2,5,1) = px_py_dyz_s;
gout(1,2,6,1) = px_py_dzz_s;
gout(1,3,1,1) = px_pz_dxx_s;
gout(1,3,2,1) = px_pz_dxy_s;
gout(1,3,3,1) = px_pz_dxz_s;
gout(1,3,4,1) = px_pz_dyy_s;
gout(1,3,5,1) = px_pz_dyz_s;
gout(1,3,6,1) = px_pz_dzz_s;
gout(2,1,1,1) = py_px_dxx_s;
gout(2,1,2,1) = py_px_dxy_s;
gout(2,1,3,1) = py_px_dxz_s;
gout(2,1,4,1) = py_px_dyy_s;
gout(2,1,5,1) = py_px_dyz_s;
gout(2,1,6,1) = py_px_dzz_s;
gout(2,2,1,1) = py_py_dxx_s;
gout(2,2,2,1) = py_py_dxy_s;
gout(2,2,3,1) = py_py_dxz_s;
gout(2,2,4,1) = py_py_dyy_s;
gout(2,2,5,1) = py_py_dyz_s;
gout(2,2,6,1) = py_py_dzz_s;
gout(2,3,1,1) = py_pz_dxx_s;
gout(2,3,2,1) = py_pz_dxy_s;
gout(2,3,3,1) = py_pz_dxz_s;
gout(2,3,4,1) = py_pz_dyy_s;
gout(2,3,5,1) = py_pz_dyz_s;
gout(2,3,6,1) = py_pz_dzz_s;
gout(3,1,1,1) = pz_px_dxx_s;
gout(3,1,2,1) = pz_px_dxy_s;
gout(3,1,3,1) = pz_px_dxz_s;
gout(3,1,4,1) = pz_px_dyy_s;
gout(3,1,5,1) = pz_px_dyz_s;
gout(3,1,6,1) = pz_px_dzz_s;
gout(3,2,1,1) = pz_py_dxx_s;
gout(3,2,2,1) = pz_py_dxy_s;
gout(3,2,3,1) = pz_py_dxz_s;
gout(3,2,4,1) = pz_py_dyy_s;
gout(3,2,5,1) = pz_py_dyz_s;
gout(3,2,6,1) = pz_py_dzz_s;
gout(3,3,1,1) = pz_pz_dxx_s;
gout(3,3,2,1) = pz_pz_dxy_s;
gout(3,3,3,1) = pz_pz_dxz_s;
gout(3,3,4,1) = pz_pz_dyy_s;
gout(3,3,5,1) = pz_pz_dyz_s;
gout(3,3,6,1) = pz_pz_dzz_s;
end