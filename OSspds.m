function gout = OSspds(RPAValues,RPBValues,RQCValues,RQDValues,RWPValues,RWQValues,pValues,qValues,ppqValues,gSSSSNValues)
...
gout = zeros(1,3,6,1);
gout(1,1,1,1) = s_px_dxx_s;
gout(1,1,2,1) = s_px_dxy_s;
gout(1,1,3,1) = s_px_dxz_s;
gout(1,1,4,1) = s_px_dyy_s;
gout(1,1,5,1) = s_px_dyz_s;
gout(1,1,6,1) = s_px_dzz_s;
gout(1,2,1,1) = s_py_dxx_s;
gout(1,2,2,1) = s_py_dxy_s;
gout(1,2,3,1) = s_py_dxz_s;
gout(1,2,4,1) = s_py_dyy_s;
gout(1,2,5,1) = s_py_dyz_s;
gout(1,2,6,1) = s_py_dzz_s;
gout(1,3,1,1) = s_pz_dxx_s;
gout(1,3,2,1) = s_pz_dxy_s;
gout(1,3,3,1) = s_pz_dxz_s;
gout(1,3,4,1) = s_pz_dyy_s;
gout(1,3,5,1) = s_pz_dyz_s;
gout(1,3,6,1) = s_pz_dzz_s;
end