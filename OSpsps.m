function gout = OSpsps(RPAValues,RPBValues,RQCValues,RQDValues,RWPValues,RWQValues,pValues,qValues,ppqValues,gSSSSNValues)
...
gout = zeros(3,1,3,1);
gout(1,1,1,1) = px_s_px_s;
gout(1,1,2,1) = px_s_py_s;
gout(1,1,3,1) = px_s_pz_s;
gout(2,1,1,1) = py_s_px_s;
gout(2,1,2,1) = py_s_py_s;
gout(2,1,3,1) = py_s_pz_s;
gout(3,1,1,1) = pz_s_px_s;
gout(3,1,2,1) = pz_s_py_s;
gout(3,1,3,1) = pz_s_pz_s;
end