function gout = OSppsp(RPAValues,RPBValues,RQCValues,RQDValues,RWPValues,RWQValues,pValues,qValues,ppqValues,gSSSSNValues)
...
gout = zeros(3,3,1,3);
gout(1,1,1,1) = px_px_s_px;
gout(1,1,1,2) = px_px_s_py;
gout(1,1,1,3) = px_px_s_pz;
gout(1,2,1,1) = px_py_s_px;
gout(1,2,1,2) = px_py_s_py;
gout(1,2,1,3) = px_py_s_pz;
gout(1,3,1,1) = px_pz_s_px;
gout(1,3,1,2) = px_pz_s_py;
gout(1,3,1,3) = px_pz_s_pz;
gout(2,1,1,1) = py_px_s_px;
gout(2,1,1,2) = py_px_s_py;
gout(2,1,1,3) = py_px_s_pz;
gout(2,2,1,1) = py_py_s_px;
gout(2,2,1,2) = py_py_s_py;
gout(2,2,1,3) = py_py_s_pz;
gout(2,3,1,1) = py_pz_s_px;
gout(2,3,1,2) = py_pz_s_py;
gout(2,3,1,3) = py_pz_s_pz;
gout(3,1,1,1) = pz_px_s_px;
gout(3,1,1,2) = pz_px_s_py;
gout(3,1,1,3) = pz_px_s_pz;
gout(3,2,1,1) = pz_py_s_px;
gout(3,2,1,2) = pz_py_s_py;
gout(3,2,1,3) = pz_py_s_pz;
gout(3,3,1,1) = pz_pz_s_px;
gout(3,3,1,2) = pz_pz_s_py;
gout(3,3,1,3) = pz_pz_s_pz;
end