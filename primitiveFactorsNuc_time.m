function [RPAValues,RPBValues,RPCValues,RAB,pValues,VssNValues,tInitVectors,tLoopVectors] = primitiveFactorsNuc_time(basis_a,basis_b,L1,L2,Boys_Table,AL,Z)
...
[xValues,KabValues,RPAValues,RPBValues,RPCValues,pValues,WeightValues,ZValues] = loopPrimitivesNuc(basis_a,basis_b,Z,AL);


tLoopVectors = tLoopVectors + toc;
...
boysValuesLow = zeros(length(xValuesLow),(L1+L2+1));
    for order = 0:(L1+L2)
